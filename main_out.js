(function(f, l) {
    ...
    function pa() {
        ...
        J = Math.max(J, eb());
        0 != J && (null == ja && (ja = new ka(24, "#FFFFFF")), ja.u("Skor: " + ~~(J / 100)), c = ja.H(), a = c.width, g.globalAlpha = .2, g.fillStyle = "#000000", g.fillRect(10, s - 10 - 24 - 10, a + 10, 34), g.globalAlpha = 1, g.drawImage(c, 15, s - 10 - 24 - 5));
        fb();
        b = Date.now() - b;
